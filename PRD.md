...
|**Goal**|**Metric**|**MileStone**|
|:-|:-|:-|
|PRD has to be in published state|To be reviewed and approved by snappyflow team|**1**|
|Jenkins plugin has to be in published state|Code to be reviewed and approved by snappyflow team|**1**|
|Jenkins plugin has to be in published state|Code to be reviewed and approved by jenkins team|**3**|
|Dashboard|Template to be reviewed and approved by snappyflow team|**2**|
|User must be alerted when jenkins is not working as expected|Details of alerts to be reviewed and approved by snappyflow team as stated in PRD|**2**|
|Design Doc||**1**|
|End User Guide||**3**|
|Documenation for snappyflow website|To be reviewed and approved by snappyflow team|**2**|
|Usecase where jekins monitoring is helpful in debugging jenkins performance issues|To be reviewed and approved by snappyflow team as indicated in PRD|**1**|
