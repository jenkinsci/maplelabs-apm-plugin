...
@Extension
public class SnappyflowQueuePublisher extends PeriodicWork{
	
    private static final Logger logger = Logger.getLogger(SnappyflowQueuePublisher.class.getName());
	...
	protected void doRun() throws Exception {
        try {
            ...
            //TODO Get Snappyflow Client Instance
